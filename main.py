...
def run():
    ...
    with tf.Session() as sess:
        ...
        logits, train_op, cross_ent_loss = optimize(layer_output, correct_label, learning_rate, num_classes)


        # TODO: Train NN using the train_nn function
        train_nn(sess, epochs, batch_size, get_batches_fn, train_op, cross_ent_loss, vgg_input,
                 correct_label, keep_prob, learning_rate)
        #try something optional video
        #
